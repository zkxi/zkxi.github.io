...
console.log('Zhang KunXiang`Website');
var re = /x/;
console.log(re);
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'https://api.fghrsh.net/live2d/get/?id='+modelId+'-'+modelTexturesId, console.log('zkx-live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
